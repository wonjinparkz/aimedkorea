...
class QnaPostResource extends PostResource
{
    ...
    {
        return (PermissionHelper::hasPermission('section_content-view') && PermissionHelper::hasPermission('qna_posts-view')) || PermissionHelper::isAdmin();
    }
    
    // 권한 메서드들
    public static function canViewAny(): bool
    {
        return PermissionHelper::hasPermission('qna_posts-view');
    }
    
    public static function canCreate(): bool
    {
        return PermissionHelper::hasPermission('qna_posts-create');
    }
    
    public static function canEdit($record): bool
    {
        return PermissionHelper::hasPermission('qna_posts-edit');
    }
    
    public static function canDelete($record): bool
    {
        return PermissionHelper::hasPermission('qna_posts-delete');
    }
}